...
- **승인된 판은 고치지 않는다.** 고치려면 **개정 시작** → 현재 판을 통째로 복사한 **초안(다음 판 번호)** → 고친 뒤 승인. 초안은 표준서당 하나. 승인 전까지는 기존 판을 그대로 사용하고, 초안은 버릴 수 있다. **초안이 있는 동안은 폐기할 수 없다** — 먼저 버리거나 승인하라고 안내한다
...
| 폐기 | ARCHIVED | 관리자가 폐기. 선택 불가, 개정 불가. 작성 중인 초안이 있으면 폐기되지 않는다(먼저 버리거나 승인). 기존 지시서에는 영향 없음 |
